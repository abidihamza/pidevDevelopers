 ...
 * @author MBM info
 */
public class voyage_propositionForm extends javax.swing.JFrame {

    /**
     * Creates new form voyage_propositionForm
     */
    public voyage_propositionForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("proposition du voyage");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(voyage_propositionForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new voyage_propositionForm().setVisible(true);
            }
        });
    }
