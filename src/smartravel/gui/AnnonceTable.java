...
public class AnnonceTable extends AbstractTableModel{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex){
            ...
            case 1: return annonces.get(rowIndex).getDestination();
            case 2: return annonces.get(rowIndex).getBudget();
            case 3: return annonces.get(rowIndex).getDate_depart();
            case 4: return annonces.get(rowIndex).getDate_retour();     
            case 5: return annonces.get(rowIndex).getMoyen_transport();
            case 6: return annonces.get(rowIndex).getItineraire();    
            case 7: return annonces.get(rowIndex).getNb_place(); 
            case 8: return annonces.get(rowIndex).getProgramme();                              
